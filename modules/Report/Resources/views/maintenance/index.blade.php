<x-app-layout>
    <x-card>
            ...
            <div class="col-sm-12 col-xl-4">
                <div class="form-group row mb-1">
                    <label for="maintenance_type"
                        class="col-sm-5 col-form-label justify-content-start text-left">@localize('Maintenance Type') </label>
                    </label>
                    <div class="col-sm-7">
                        <select class="form-control basic-single" name="maintenance_type_id" id="maintenance_type"
                            tabindex="-1" aria-hidden="true">
                            <option value="">@localize('Please Select One')</option>
                            @foreach ($maintenance_types as $key => $value)
        ...
        <div>
            ...
            <div id="page-axios-data" data-table-id="#vehicle-maintenance-table"></div>
        </div>
    </x-card>
</x-app-layout>
