...
class VehicleDivisionDataTable extends DataTable
{
    /**
     ...
     */
    public function query(VehicleDivision $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('vehicle-division-table')
    ...
    {
        return 'vehicle-division-'.date('YmdHis');
    }
}
