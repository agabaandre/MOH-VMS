...
class VehicleInsuranceRecurringPeriodDataTable extends DataTable
{
    /**
     ...
     */
    public function query(VehicleInsuranceRecurringPeriod $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('vehicle-insurance-recurring-period-table')
    ...
    {
        return 'vehicle-insurance-recurring-period-'.date('YmdHis');
    }
}
