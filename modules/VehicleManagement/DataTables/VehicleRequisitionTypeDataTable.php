...
class VehicleRequisitionTypeDataTable extends DataTable
{
    /**
     ...
     */
    public function query(VehicleRequisitionType $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('vehicle-requisition-type-table')
    ...
    {
        return 'vehicle-requisition-type-'.date('YmdHis');
    }
}
