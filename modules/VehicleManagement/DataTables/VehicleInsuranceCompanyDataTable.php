...
class VehicleInsuranceCompanyDataTable extends DataTable
{
    /**
     ...
     */
    public function query(VehicleInsuranceCompany $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('vehicle-insurance-company-table')
    ...
    {
        return 'vehicle-insurance-company-'.date('YmdHis');
    }
}
