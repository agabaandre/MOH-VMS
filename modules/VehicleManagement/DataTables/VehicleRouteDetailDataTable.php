...
class VehicleRouteDetailDataTable extends DataTable
{
    /**
     ...
     */
    public function query(VehicleRouteDetail $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('vehicle-route-detail-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('route_name')->title(localize('Route Name'))->defaultContent('N/A'),
            Column::make('starting_point')->title(localize('Starting Point'))->defaultContent('N/A'),
            Column::make('destination_point')->title(localize('Destination Point'))->defaultContent('N/A'),
    ...
    {
        return 'vehicle-route-detail'.date('YmdHis');
    }
}
