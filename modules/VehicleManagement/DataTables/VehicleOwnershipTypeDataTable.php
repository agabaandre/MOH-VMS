...
class VehicleOwnershipTypeDataTable extends DataTable
{
    /**
     ...
     */
    public function query(VehicleOwnershipType $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('vehicle-ownership-type-table')
    ...
    {
        return 'vehicle-ownership-type-'.date('YmdHis');
    }
}
