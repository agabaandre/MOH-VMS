...
class RequisitionPurposeDataTable extends DataTable
{
    /**
     ...
     */
    public function query(VehicleRequisitionPurpose $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('vehicle-requisition-purpose-table')
    ...
    {
        return 'vehicle-requisition-purpose-table-'.date('YmdHis');
    }
}
