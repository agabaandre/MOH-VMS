...
class InventoryLocationDataTable extends DataTable
{
    ...
    {
        return $this->builder()
            ->setTableId('inventory-location-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('room')->title(localize('Room'))->defaultContent('N/A'),
            Column::make('self')->title(localize('Self'))->defaultContent('N/A'),
            Column::make('drawer')->title(localize('Drawer'))->defaultContent('N/A'),
            Column::make('capacity')->title(localize('Capacity'))->defaultContent('N/A'),
            Column::make('dimension')->title(localize('Dimension'))->defaultContent('N/A'),
    ...
    {
        return 'inventory-location-'.date('YmdHis');
    }
}
