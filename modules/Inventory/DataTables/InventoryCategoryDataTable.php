...
class InventoryCategoryDataTable extends DataTable
{
    /**
     ...
     */
    public function query(InventoryCategory $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('inventory-category-table')
    ...
    {
        return 'inventory-category-'.date('YmdHis');
    }
}
