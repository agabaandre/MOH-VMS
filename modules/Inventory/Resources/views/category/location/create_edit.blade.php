            ...
            <tr>
                ...
                <td>
                    <input type="number" class="form-control" name="room" id="room"
                        value="{{ isset($item) ? $item->room : old('room') }}" min="0"
                        placeholder="@localize('room')">
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="number" class="form-control" name="self" id="self"
                        value="{{ isset($item) ? $item->self : old('self') }}" min="0"
            ...
            <tr>
                ...
                <td>
                    <input type="number" class="form-control" name="drawer" id="drawer"
                        value="{{ isset($item) ? $item->drawer : old('drawer') }}" min="0"
            ...
            <tr>
                ...
                <td>
                    <input type="number" class="form-control" name="capacity" id="capacity"
                        value="{{ isset($item) ? $item->capacity : old('capacity') }}" min="0"
            ...
            <tr>
                ...
                <td>
                    <input type="number" class="form-control" name="dimension" id="dimension"
                        value="{{ isset($item) ? $item->dimension : old('dimension') }}" min="0"
