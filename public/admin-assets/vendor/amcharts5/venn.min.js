...
(self.webpackChunk_am5 = self.webpackChunk_am5 || []).push([
    [5868],
    {
        8034: function (e, t, r) {
            ...
            function l(e, t, r) {
                function n(e) {
                    for (var t = 0; t < e.length; t++) x[v][t] = e[t];
                    x[v].fx = e.fx;
                }
                var a,
                    i = (r = r || {}).maxIterations || 200 * t.length,
                    s = r.nonZeroDelta || 1.05,
                    o = r.zeroDelta || 0.001,
                    l = r.minErrorDelta || 1e-6,
                    f = r.minErrorDelta || 1e-5,
                    h = void 0 !== r.rho ? r.rho : 1,
                    c = void 0 !== r.chi ? r.chi : 2,
                    g = void 0 !== r.psi ? r.psi : -0.5,
                    p = void 0 !== r.sigma ? r.sigma : 0.5,
                    v = t.length,
                    x = new Array(v + 1);
                (x[0] = t), (x[0].fx = e(t)), (x[0].id = 0);
                for (var y = 0; y < v; ++y) {
                    var d = t.slice();
                    (d[y] = d[y] ? d[y] * s : o),
                        (x[y + 1] = d),
                ...
                for (
                    ...
                    if ((x.sort(m), r.history)) {
                        var _ = x.map(function (e) {
                            var t = e.slice();
                    ...
                    for (a = 0, y = 0; y < v; ++y)
                        a = Math.max(a, Math.abs(x[0][y] - x[1][y]));
                    if (Math.abs(x[0].fx - x[v].fx) < l && a < f) break;
                    for (y = 0; y < v; ++y) {
                        b[y] = 0;
                        for (var z = 0; z < v; ++z) b[y] += x[z][y];
                        b[y] /= v;
                    }
                    var D = x[v];
                    if ((u(w, 1 + h, b, -h, D), (w.fx = e(w)), w.fx < x[0].fx))
                        u(P, 1 + c, b, -c, D),
                            (P.fx = e(P)),
                            P.fx < w.fx ? n(P) : n(w);
                    else if (w.fx >= x[v - 1].fx) {
                        var O = !1;
                        if (
                            (w.fx > D.fx
                                ? (u(M, 1 + g, b, -g, D),
                ...
                return x.sort(m), { fx: x[0].fx, x: x[0] };
            }
            function f(e, t, r, n, a, s, o) {
                function l(l, g, v) {
                    for (var x = 0; x < 16; ++x)
                        if (
                            ((a = (l + g) / 2),
                            u(n.x, 1, r.x, a, t),
                            (c = n.fx = e(n.x, n.fxprime)),
                            (p = i(n.fxprime, t)),
                            c > f + s * a * h || c >= v)
                        )
                            g = a;
                        else {
                            if (Math.abs(p) <= -o * h) return a;
                            p * (g - l) >= 0 && (g = l), (l = a), (v = c);
                        }
                    return 0;
                }
            ...
            function h(e, t, r) {
                var n,
                    a,
                    l,
                    h = { x: t.slice(), fx: 0, fxprime: t.slice() },
                    c = { x: t.slice(), fx: 0, fxprime: t.slice() },
                    g = t.slice(),
                    p = 1;
                (l = (r = r || {}).maxIterations || 20 * t.length),
                    (h.fx = e(h.x, h.fxprime)),
                    o((n = h.fxprime.slice()), h.fxprime, -1);
                for (var v = 0; v < l; ++v) {
                    if (
                        ((p = f(e, n, h, c, p)),
                        r.history &&
                            r.history.push({
                                x: h.x.slice(),
                                fx: h.fx,
                                fxprime: h.fxprime.slice(),
                                alpha: p,
                            }),
                        p)
                    ) {
                        u(g, 1, c.fxprime, -1, h.fxprime);
                        var x = i(h.fxprime, h.fxprime);
                        u(
                            n,
                            Math.max(0, i(g, c.fxprime) / x),
                            n,
                            -1,
                            c.fxprime
                        ),
                            ...
                            (h = c),
                            (c = a);
                    } else o(n, h.fxprime, -1);
                    if (s(h.fxprime) <= 1e-5) break;
                }
                return (
                    r.history &&
                        r.history.push({
                    ...
                    a = n.filter(function (t) {
                        return (function (e, t) {
                            for (var r = 0; r < t.length; ++r)
                                if (p(e, t[r]) > t[r].radius + 1e-10) return !1;
                            return !0;
                        })(t, e);
                    }),
                    i = 0,
                ...
                if (a.length > 1) {
                    ...
                    for (r = 0; r < a.length; ++r) {
                        ...
                        for (
                            ...
                            if (f.parentIndex.indexOf(h.parentIndex[d]) > -1) {
                                var m = e[h.parentIndex[d]],
                                    b = Math.atan2(h.x - m.x, h.y - m.y),
                                    w = Math.atan2(f.x - m.x, f.y - m.y),
                                    M = w - b;
                                M < 0 && (M += 2 * Math.PI);
                                var P = w - M / 2,
                                    I = p(c, {
                                        x: m.x + m.radius * Math.sin(P),
                                        y: m.y + m.radius * Math.cos(P),
                                    });
                                I > 2 * m.radius && (I = 2 * m.radius),
                                    (null === v || v.width > I) &&
                                        (v = {
                                            circle: m,
                                            width: I,
                        ...
                        null !== v &&
                            (o.push(v),
                            (i += g(v.circle.radius, v.width)),
                            (f = h));
                    }
                } else {
                    var _ = e[0];
                    for (r = 1; r < e.length; ++r)
                        e[r].radius < _.radius && (_ = e[r]);
                    var z = !1;
                    for (r = 0; r < e.length; ++r)
                        if (p(e[r], _) > Math.abs(_.radius - e[r].radius)) {
                            z = !0;
                            break;
                        }
                    z
                        ? (i = s = 0)
                        : ((i = _.radius * _.radius * Math.PI),
                          o.push({
                              circle: _,
                              p1: { x: _.x, y: _.y + _.radius },
                              p2: { x: _.x - 1e-10, y: _.y + _.radius },
                              width: 2 * _.radius,
                          }));
                }
                return (
            ...
            function v(e, t, r) {
                ...
                return g(e, e - (r * r - t * t + e * e) / (2 * r)) + g(t, n);
            }
            function x(e, t) {
                var r = p(e, t),
                    n = e.radius,
            ...
            function m(e, t) {
                var r = (function (e, t) {
                        ...
                        function a(e, t) {
                            (o[t].x = e.x), (o[t].y = e.y), (m[t] = !0);
                        }
                        for (
                            var i,
                                s = t && t.lossFunction ? t.lossFunction : b,
                                o = {},
                                u = {},
                                l = 0;
                            l < e.length;
                        ...
                        for (
                            ...
                            var h = e[l],
                                c = h.hasOwnProperty("weight") ? h.weight : 1,
                                g = h.sets[0],
                                p = h.sets[1];
                            h.size + 1e-10 >= Math.min(o[g].size, o[p].size) &&
                                (c = 0),
                                u[g].push({ set: p, size: h.size, weight: c }),
                                u[p].push({ set: g, size: h.size, weight: c });
                        }
                        var v = [];
                        for (i in u)
                            if (u.hasOwnProperty(i)) {
                                var y = 0;
                                for (l = 0; l < u[i].length; ++l)
                                    y += u[i][l].size * u[i][l].weight;
                                v.push({ set: i, size: y });
                            }
                        v.sort(r);
                        var m = {};
                        for (
                            a({ x: 0, y: 0 }, v[0].set), l = 1;
                            l < v.length;
                            ++l
                        ) {
                            var w = v[l].set,
                                M = u[w].filter(n);
                            if (((i = o[w]), M.sort(r), 0 === M.length))
                                throw "ERROR: missing pairwise overlap information";
                            for (var P = [], I = 0; I < M.length; ++I) {
                                var _ = o[M[I].set],
                                    z = d(i.radius, _.radius, M[I].size);
                                P.push({ x: _.x + z, y: _.y }),
                                    P.push({ x: _.x - z, y: _.y }),
                                    P.push({ y: _.y + z, x: _.x }),
                                    P.push({ y: _.y - z, x: _.x });
                                for (var D = I + 1; D < M.length; ++D)
                                    for (
                                        var O = o[M[D].set],
                                            R = d(
                                                i.radius,
                ...
                if (e.length >= 8) {
                    var u = (function (e, t) {
                        ...
                        for (r = 0; r < e.length; ++r) {
                            var f = e[r];
                            1 == f.sets.length &&
                                ((l[f.sets[0]] = u.length), u.push(f));
                        }
                        var c = (function (e, t, r) {
                                var n = a(t.length, t.length),
                                    i = a(t.length, t.length);
                                return (
                                    e
                                        .filter(function (e) {
                                            return 2 == e.sets.length;
                        ...
                        for (r = 0; r < i; ++r)
                            (y = h(m, n(2 * g.length).map(Math.random), t)),
                                (!x || y.fx < x.fx) && (x = y);
                        var b = x.x,
                            w = {};
            ...
            function w(e, t, r) {
                ...
                if (
                    (2 == e.length &&
                        p(e[0], e[1]) < Math.abs(e[1].radius - e[0].radius) &&
            ...
            function P(e, t, r) {
                var n,
                    a,
                    i = t[0].radius - p(t[0], e);
                for (n = 1; n < t.length; ++n)
                    (a = t[n].radius - p(t[n], e)) <= i && (i = a);
                for (n = 0; n < r.length; ++n)
                    (a = p(r[n], e) - r[n].radius) <= i && (i = a);
                return i;
            }
            function I(e, t) {
                var r,
                ...
                var u = l(
                    ...
                    h = !0;
                for (r = 0; r < e.length; ++r)
                    if (p(f, e[r]) > e[r].radius) {
                        h = !1;
                        break;
                    }
                for (r = 0; r < t.length; ++r)
                    if (p(f, t[r]) < t[r].radius) {
                        h = !1;
                        break;
                    }
                if (!h)
                    if (1 == e.length) f = { x: e[0].x, y: e[0].y };
                    else {
                        var g = {};
                        c(e, g),
                            (f =
            ...
            var H = (function (e) {
                ...
                return (
                    ...
                    Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        writable: !0,
                        value: function () {
                            this._defaultThemes.push(k.new(this._root)),
                                this.fields.push(
                                    "intersections",
                                    "category",
                                    "fill"
                    ...
                    Object.defineProperty(t.prototype, "_makeSlices", {
                        ...
                        value: function () {
                            var e = this;
                            return new N.o(A.YS.new({}), function () {
                                return T.T._new(
                                    e._root,
                                    {
                    ...
                    Object.defineProperty(t.prototype, "_prepareChildren", {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                var r = [];
                                q.each(this.dataItems, function (e) {
                                    var t = {},
                                ...
                                if (((this._sets = n), r.length > 0)) {
                                    ...
                                    for (var s in a) {
                                        var o = a[s],
                                            u = o.radius,
                                            f = this.getDataItemByCategory(s);
                                        if (f) {
                                            var h = f.get("slice"),
                                                g = f.get("fill");
                                            h._setDefault("fill", g),
                                                h._setDefault("stroke", g),
                                                this.updateLegendMarker(f),
                                                h.set(
                                                    "svgPath",
                                                    "M" +
                                                        o.x +
                    ...
                    Object.defineProperty(
                        ...
                        "getDataItemByCategory",
                        {
                            ...
                            writable: !0,
                            value: function (e) {
                                return q.find(this.dataItems, function (t) {
                                        ...
                                        case 0:
                                            return (
                                                ...
                                                (s = t.animate({
                                                    ...
                                                    duration: r,
                                                    easing: a,
                                                })) && n.push(s.waitForStop()),
                                                (o = t.get("label")) &&
                                                    n.push(o.show(r)),
                                                (u = t.get("slice")) &&
                                                    n.push(u.show(r)),
                                                (l = t.get("intersections")) &&
                                                    q.each(l, function (e) {
                                                        var t =
                                                            h.getDataItemByCategory(
                                                                e
                                                            );
                                                        t &&
                                                            t.isHidden() &&
                    ...
                    Object.defineProperty(t, "classNames", {
                        ...
                        configurable: !0,
                        writable: !0,
                        value: j.F.classNames.concat([t.className]),
                    }),
                    t
                );
            })(j.F);
